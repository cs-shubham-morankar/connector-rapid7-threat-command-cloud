...
The `Sample - Rapid7 Threat Command Cloud - 1.0.0` playbook collection comes bundled with the Rapid7 Threat Command
Cloud connector. These playbooks contain steps using which you can perform all supported actions. You can see bundled
playbooks in the **Automation** > **Playbooks** section in FortiSOAR<sup>TM</sup> after importing the Rapid7 Threat
